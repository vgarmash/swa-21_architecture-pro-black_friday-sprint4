...
> 📖 Документация по настройке шардирования MongoDB для проекта "Мобильный мир"  
> 🏠 [← Вернуться к README](README.md) | 📊 [Схема архитектуры →](diagrams/ARCHITECTURE.md)
...
- 📊 [Схема 2: Шардирование + Репликация](diagrams/ARCHITECTURE.md#схема-2-шардирование--репликация)
